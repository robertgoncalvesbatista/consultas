  ...
  return (
    <div className="flex flex-1 flex-col gap-6 p-6 pt-4 mx-auto">
      <div className="space-y-2">
        <h1 className="text-2xl font-bold tracking-tight">Pagamento via Pix</h1>
        ...
        <Card className="max-w-lg">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <span className="text-xs font-medium whitespace-normal break-words line-clamp-4">
                Ao realizar a transferência, aguarde! Seu pagamento ser&aacute;
                processado em instantes.
              </span>
            </div>
          </CardContent>
        </Card>
